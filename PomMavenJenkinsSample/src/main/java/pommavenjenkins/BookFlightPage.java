...
//@CacheLookup
//WebElement logout;
//@FindBy(how=How.XPATH,using="/html/body/div[2]/table/tbody/tr/td[1]/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr[1]/td[2]/a")
...
WebElement purchase;*/
public void Home() {
System.out.println("Welcome to BookFlightPage");
try {
Thread.sleep(2000);
BACKTOHOME.click();
